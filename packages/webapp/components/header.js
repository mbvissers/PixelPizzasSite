  ...
  return (
    <>
      ...
      <div className={"p-8 " + props.bgClass}>
        <div
          className={
            "flex flex-grow flex-row items-center justify-between container xl:px-48 mx-auto"
          }
        >
          ...
          <button
            className={
              "flex justify-center align-center rounded-md bg-white p-2 inline md:hidden" +
              (address ? " bg-green-400" : " bg-white")
            }
          >
