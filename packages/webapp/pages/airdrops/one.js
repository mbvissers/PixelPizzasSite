    ...
    <FullscreenLayout noHeader={false} headerBgClass={"bg-yellow-300"}>
      ...
      <div className={"p-8 pb-0 "}>
        <div className={"container xl:px-48 mx-auto"}>
          ...
          <div
            className={
              "flex flex-grow items-center flex-col lg:flex-row justify-between pt-8 lg:pt-32 h-max"
            }
          >
            <div className={"pb-8 lg:pr-24"}>
              <h1
                className={
                  "text-5xl md:text-6xl font-bold text-black mb-4 text-center lg:text-left"
                }
              >
                Pixel Pizzas
              </h1>
              <h2
                className={
                  "text-xl md:text-4xl font-bold text-black text-center lg:text-left"
                }
              >
                Airdrop #1
              </h2>
